...
# Parameters
# import Parameters as param  # TODO: "Parameters" must be the name of .py script containing parameters, c.f. params directory
param = importlib.import_module("params.Parameters_8_1e-2_LR")
...
def loadimgs(path, window, bands, hop_length, img_height, img_width, n_samples_max):
    ...
    for participant in os.listdir(path):
        ...
        if participant != ".DS_Store":
            ...
            # Read all audio files of the current participant and convert them to mel-spectrograms

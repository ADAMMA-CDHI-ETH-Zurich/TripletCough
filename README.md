...
This repository contains the code to reproduce the experiments in the paper *TripletCough: Cougher Identification and Verification from Contact-Free Smartphone-Based Audio Recordings Using Metric Learning* by [Stefan Jokić](https://github.com/sjokic)\*, [David Cleres](https://github.com/dcleres), Frank Rassouli, Claudia Steurer-Stey, Milo A. Puhan, Martin Brutsche, Elgar Fleisch, and [Dr. sc. Filipe Barata](https://github.com/pipo3000)\*.
